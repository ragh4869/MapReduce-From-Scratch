...
class map:
    ...
    def __init__(self, filename):
        ...
        self.lines = ""
        self.doc_id = self.filename.split('_')[0]
...
def map_wc(mapper_barrier, filename):
    ...
    mapper_barrier.wait() # Wait for all the mapper processes to end

# Defining mapper function for inverted-index
def map_inv_ind(mapper_barrier, filename):
